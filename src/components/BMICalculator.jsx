  ...
  return (
    <section className="bmi">
      ...
      <div className="container">
        ...
        <div className="wrapper">
          <img src="https://media.istockphoto.com/id/528072248/photo/bmi-body-mass-index-written-on-a-notepad-sheet.jpg?b=1&s=612x612&w=0&k=20&c=A1_t_wz-GymukQ_BWCex8ezZs0pnU0pYu7mdN_zto_Q=" alt="bmiimage" />
        </div>
      </div>
    </section>
  );
